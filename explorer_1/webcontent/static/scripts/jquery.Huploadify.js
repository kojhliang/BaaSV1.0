...
$.fn.Huploadify = function(opts){
	...
	this.each(function(){
		...
		// inputStr += '"/>';
		// inputStr += '<a id="file_upload_1-button" href="javascript:void(0)" class="uploadify-button">';
		// inputStr += option.buttonText;
		// inputStr += '</a>';
		var uploadFileListStr = '<div id="file_upload_1-queue" class="uploadify-queue"></div>';
		// _this.append(inputStr+uploadFileListStr);
		_this.append(uploadFileListStr);
