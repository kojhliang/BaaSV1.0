...
var getBlockByNumber = function(peer, blockNumber, username, org,channelName) { //edit by lmh 20170904,content:add channelName param
	var target = buildTarget(peer, org);
    var channel = helper.getChannelForOrg(channelName,org);//edit by lmh 20170904,content:add channelName param
...
var getTransactionByID = function(peer, trxnID, username, org, channelName) {//edit by lmh 20170904,content:add channelName param
	var target = buildTarget(peer, org);
    var channel = helper.getChannelForOrg(channelName,org);//edit by lmh 20170904,content:add channelName param
...
var getBlockByHash = function(peer, hash, username, org, channelName) {//edit by lmh 20170904,content:add channelName param
	var target = buildTarget(peer, org);
    var channel = helper.getChannelForOrg(channelName,org);//edit by lmh 20170904,content:add channelName param
...
var getInstalledChaincodes = function(peer, type, username, org,channelName) {//edit by lmh 20170904,content:add channelName param
	var target = buildTarget(peer, org);
    var channel = helper.getChannelForOrg(channelName,org);//edit by lmh 20170904,content:add channelName param
	var client = helper.getClientForOrg(org);
...
var getChannels = function(peer, username, org) {
	var target = buildTarget(peer, org);
	//var channel = helper.getChannelForOrg(org);   uncomment by lmh ,actually it doesn't work ,no use
	var client = helper.getClientForOrg(org);
